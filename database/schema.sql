-- ============================================================
-- AvtoTest Pro — MySQL sxema (to'liq)
...
CREATE TABLE IF NOT EXISTS `obunalar` (
    ...
    INDEX `idx_holat_tugash`  (`holat`, `tugash`),
...
CREATE TABLE IF NOT EXISTS `natijalar` (
    ...
    -- qolgan_vaqt = testning BOSHLANG'ICH muddati (o'zgarmas, sanani hisoblash uchun)
...
-- 11. FIKRLAR (+ fikr_ip yangi ustun)
...
('payme_key',           '',                                     'Payme kaliti'),
('referal_bonus',       '5000',                                 'Referal bonus (so\'m)'),
('test_vaqti_minut',    '25',                                   'Test vaqti (daqiqada)'),
('savol_soni_test',     '20',                                   'Testdagi savollar soni'),
('cron_kalit',          '',                                     'Cron himoya kaliti')
